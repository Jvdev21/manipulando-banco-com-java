...
public class UpdateLogin {
    ...
    public void atualizarLogin(String idlogin, Login novoLogin) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            statement.setString(1, novoLogin.getCod_classe());
    ...
    public static void main(String[] args) {
        ...
        try (Connection conexao = DriverManager.getConnection("jdbc:postgresql://localhost:5432/QFK",
            ...
            Login novoLogin = new Login("1", "Alta", "exemplo_idlogin", "novoemail@example.com", "novasenha", "Novo Nome", Date.valueOf(String.valueOf(2004 - 26 - 12)));
